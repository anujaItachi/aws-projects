...
// var controller = (function(bugetCntr, UICntr){
//     var z = bugetCntr.publicTest(8)
...
// 17) budget problem (event listener)
var budgetController = (function () {
...
var controller = (function (bagetCntr, UICntr) {
    ...
    var setupEventListeners = function () {
        ...
        document.querySelector(DOM.inputType).addEventListener('change', UICntr.changedType);
    ...
    var cntrlAddItem = function () {
        ...
        if (input.description != "" && !isNaN(input.value) && input.value > 0) {
            ...
            newItem = bagetCntr.addItem(input.type, input.description, input.value);
